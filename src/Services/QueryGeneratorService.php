...
class QueryGeneratorService
{
	...
	{
		if ( self::checkIfBothArraysAreEmpty( $filterParameters, $sortingParameters ) ) {
			return '';
		}
	...
	{
		if ( \count( $sortingParameters ) === 0 ) {
			return;
		}

		if ( str_contains( $baseString, 'filter' ) ) {
			$baseString .= '&';
		}
